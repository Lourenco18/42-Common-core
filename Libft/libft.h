...
/*   Updated: 2025/10/17 11:09:53 by dasantos         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
unsigned int ft_strlcpy(char *dst, const char *src, int dstsize);    // done
unsigned int ft_strlcat(char *dst, const char *src, int dstsize);    // done
int ft_strncmp(const char *s1, const char *s2, unsigned int n);      // done
char *ft_strnstr(const char *haystack, const char *needle, int len); // done
